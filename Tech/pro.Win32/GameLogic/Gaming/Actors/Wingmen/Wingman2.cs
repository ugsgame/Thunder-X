...
{
    public class Wingman2:Wingman
    {
        public Wingman2(SpawnInfo spawnInfo)
            : base(spawnInfo)
        {
            this.WingmanID = WingmanSpawner.WingmanID.Wingman2;
        }
        protected override void Init(Thunder.GameLogic.Gaming.SpawnInfo spawnInfo)
        {
            this.Info.animName = "wingman2";
            base.Init(spawnInfo);
        ...
        protected virtual void InitBullets()
        {
            ...
            lv1 = new BulletSystem(Utils.CoverBulletPath("liaoji-02-lv1.bt"));
            lv1.SetUserEffect(comEffect);

            lv2 = new BulletSystem(Utils.CoverBulletPath("liaoji-02-lv2.bt"));
            lv2.SetUserEffect(comEffect);

            lv3 = new BulletSystem(Utils.CoverBulletPath("liaoji-02-lv3.bt"));
            lv3.SetUserEffect(comEffect);

            lv4 = new BulletSystem(Utils.CoverBulletPath("liaoji-02-lv4.bt"));
            lv4.SetUserEffect(comEffect);

            lv5 = new BulletSystem(Utils.CoverBulletPath("liaoji-02-lv5.bt"));
