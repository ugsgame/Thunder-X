...
{
    public class Wingman3 : Wingman
    {
        public Wingman3(SpawnInfo spawnInfo)
            : base(spawnInfo)
        {
            this.WingmanID = WingmanSpawner.WingmanID.Wingman3;
        }
        protected override void Init(Thunder.GameLogic.Gaming.SpawnInfo spawnInfo)
        {
            this.Info.animName = "wingman3";
            base.Init(spawnInfo);
        ...
        protected virtual void InitBullets()
        {
            ...
            lv1 = new BulletSystem(Utils.CoverBulletPath("liaoji-03-lv1.bt"));
            lv1.SetUserEffect(comEffect);

            lv2 = new BulletSystem(Utils.CoverBulletPath("liaoji-03-lv2.bt"));
            lv2.SetUserEffect(comEffect);

            lv3 = new BulletSystem(Utils.CoverBulletPath("liaoji-03-lv3.bt"));
            lv3.SetUserEffect(comEffect);

            lv4 = new BulletSystem(Utils.CoverBulletPath("liaoji-03-lv4.bt"));
            lv4.SetUserEffect(comEffect);

            lv5 = new BulletSystem(Utils.CoverBulletPath("liaoji-03-lv5.bt"));
